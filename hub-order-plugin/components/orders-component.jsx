      ...
      <Table>
        <TableHead>
          <TableRow>
            ...
            {(data.roles.includes('administrator') || data.roles.includes('customer_support')) && <TableCell>Edit</TableCell>}
          </TableRow>
        </TableHead>
        <TableBody>
            ...
            <TableRow key={order.id}>
              ...
              <TableCell>
                {(
                  ...
                  (data.roles.includes('administrator') || data.roles.includes('customer_support')) && (
                    <IconButton onClick={() => handleEdit(order.id, order.order_notes)}>
                      <EditIcon />
                    </IconButton>
                  )
                )}
